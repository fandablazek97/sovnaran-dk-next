                ...
                <div className="rounded-2xl bg-gray-200/50 p-10">
                  ...
                  <dl className="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                    <div>
                      ...
                      <dd>
                        <a className="font-semibold text-orange-600" href="mailto:collaborate@example.com">
                ...
                <div className="rounded-2xl bg-gray-200/50 p-10">
                  ...
                  <dl className="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                    <div>
                      <dt className="sr-only">Email</dt>
                      <dd>
                        <a className="font-semibold text-orange-600" href="mailto:press@example.com">
                          press@example.com
                        </a>
                      </dd>
                    </div>
                ...
                <div className="rounded-2xl bg-gray-200/50 p-10">
                  ...
                  <dl className="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                    <div>
                      <dt className="sr-only">Email</dt>
                      <dd>
                        <a className="font-semibold text-orange-600" href="mailto:careers@example.com">
                          careers@example.com
                        </a>
                      </dd>
                    </div>
                ...
                <div className="rounded-2xl bg-gray-200/50 p-10">
                  ...
                  <dl className="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                    <div>
                      <dt className="sr-only">Email</dt>
                      <dd>
                        <a className="font-semibold text-orange-600" href="mailto:hello@example.com">
                          hello@example.com
                        </a>
                      </dd>
                    </div>
